  ...
  return (
    <section className={s.section}>
      <Container className={s.container}>
        ...
        {/* Title */}
        <h2 className={s.title} data-anim="heading" suppressHydrationWarning>Visit our offices</h2>
        ...
        <div className={s.sliderSection}>
          <div className={s.sliderHeader}>
            <h3 className={s.sliderTitle} data-anim="heading" suppressHydrationWarning>Inside our office</h3>
